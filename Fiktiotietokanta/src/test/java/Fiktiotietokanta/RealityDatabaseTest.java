...
public class RealityDatabaseTest {
    ...
    public void normalModeWorks() throws Exception {
        DatabaseInterface test = new RealityDatabase("Normal");
        String givenNormalConnection = test.getConnectionString();
        assertEquals("jdbc:sqlite:realitydatabase:connection", givenNormalConnection);
    }
    
    @Test
    public void testModeWorks() throws Exception {
        DatabaseInterface test = new RealityDatabase("Test");
        String givenTestConnection = test.getConnectionString();
        assertEquals("jdbc:sqlite:realitydatabasetest:connection", givenTestConnection);
    }
